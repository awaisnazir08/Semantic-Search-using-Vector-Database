...
class ProductsCombiner:
    def __init__(self):
        pass
    
    def combine_weighted_products(self, text_results, image_results):
        all_products = {}
    ...
    def combine_results_retrieved_by_title_similarity(self, title_results, image_results):
        product_details = {}
    ...
    def combine_results_retrieved_by_image_similarity(self, product_results, image_results, all_images_of_matched_products):
